...
namespace Sheyaaka.BLL.Services
{
    public class StoreService : IStoreService
    {
        ...
        private async Task ValidateStoreCreationInput(CreateStoreInputDto createStoreInputDto)
        {
            ...
            ArgumentNullException.ThrowIfNullOrWhiteSpace(createStoreInputDto.StoreName, "Store name is required");
        ...
        private async Task<Store?> ValidateUpdateStoreRequest(UpdateStoreInputDto updateStoreInputDto, int storeId, int userId)
        {
            ...
            ArgumentNullException.ThrowIfNullOrWhiteSpace(updateStoreInputDto.StoreName, "Store name is required");
